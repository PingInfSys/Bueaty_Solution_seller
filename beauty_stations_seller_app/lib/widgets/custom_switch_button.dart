...
class _CustomSwitchButtonState extends State<CustomSwitchButton> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _animationController = AnimationController(vsync: this, duration: const Duration(milliseconds: 30));
  }
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Container(
                  width: 15.r,
                  height: 15.r,
                  decoration: const BoxDecoration(shape: BoxShape.circle, color: ColorManager.neutralWhite),
                ),
              ),
            ),
          ),
