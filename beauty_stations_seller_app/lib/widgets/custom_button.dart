...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({
    ...
    required this.text,
    this.btnColor,
    this.disActiveColor = ColorManager.neutral400,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isActive ? (btnColor ?? ColorManager.mainColor) : (disActiveColor ?? ColorManager.neutral00),
        ...
        child: Center(
          child: loading
              ? SpinKitFadingCircle(
                  color: loadingColor ?? (isDark ? ColorManager.neutralWhite : ColorManager.neutralWhite),
                  size: 26.r,
                )
              : Row(
                  ...
                  children: [
                    ...
                    CustomText(
                      title: text,
                      color: btnTextColor ?? (isActive ? ColorManager.neutralWhite : ColorManager.neutralWhite),
                      size: btnTextSize ?? 16,
