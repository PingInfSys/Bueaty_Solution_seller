...
class AppTheme {
  ThemeData appLightTheme() {
    return ThemeData(
      ...
      unselectedWidgetColor: ColorManager.neutral600.withOpacity(0.55),
      primaryColor: ColorManager.neutralWhite,

      dividerColor: ColorManager.neutral200,

      colorScheme: ThemeData().colorScheme.copyWith(
            secondary: ColorManager.neutral950,
            primary: ColorManager.neutral600,
      ...
      listTileTheme: ListTileThemeData(
        ...
        tileColor: ColorManager.neutral600,
